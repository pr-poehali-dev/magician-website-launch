        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a 
                href="#" 
                className="w-10 h-10 rounded-full bg-magic-purple/20 hover:bg-magic-purple hover:text-white flex items-center justify-center transition-colors"
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/" className="text-gray-600 hover:text-magic-purple transition-colors">
                  Главная
                </Link>
              </li>
              <li>
                <Link to="#services" className="text-gray-600 hover:text-magic-purple transition-colors">
                  Услуги
                </Link>
              </li>
              <li>
                <Link to="#gallery" className="text-gray-600 hover:text-magic-purple transition-colors">
                  Галерея
                </Link>
              </li>
              <li>
                <Link to="#testimonials" className="text-gray-600 hover:text-magic-purple transition-colors">
                  Отзывы
                </Link>
              </li>
              <li>
                <Link to="#contact" className="text-gray-600 hover:text-magic-purple transition-colors">
                  Контакты
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-600">info@master-magic.ru</span>
              </li>
              <li className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-magic-purple shrink-0 mt-0.5" />
                <span className="text-gray-600">г. Москва, выступления по всей России</span>
              </li>
            </ul>
          </div>
        </div>
